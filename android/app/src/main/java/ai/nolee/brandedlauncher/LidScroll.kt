 ...
 *
 * Debug builds also accept `ai.nolee.brandedlauncher.DEBUG_LID_STEP` from the shell, since adb cannot create our
 * PendingIntent: `adb shell am broadcast -a ai.nolee.brandedlauncher.DEBUG_LID_STEP --es direction step_up`.
 */
